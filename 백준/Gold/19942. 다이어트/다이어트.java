...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		ans = "";
		back(0, 0, new int[] { 0, 0, 0, 0 }, 0, ""); // 영양분, 총합
	...
	static void back(int cnt, int id, int[] gradient, int price, String str) {
		if (id == N) { // 종료 조건 주의
		...
		back(cnt + 1, id + 1, newGradient, price + items[id][4], str + (id + 1) + " "); // 선택하는 경우

		back(cnt, id + 1, gradient, price, str); // 선택하지 않는 경우
